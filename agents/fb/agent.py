...
class FB(AbstractAgent):
    ...
    def update_actor(
        ...
        action, log_prob = self.actor(observation, z, std, sample=True) #NOTE: return log_prob for a gaussian actor, return the distribution for the non gaussian actor (but the distribution is not used here)
